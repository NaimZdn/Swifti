...
extension Color {
    ...
    static let filterLabelSelectedText = Color("filterLabelSelectedText")
...
extension Font {
    ...
    static var scoreReviewCaption = fontSemiBold(20)
    static var scoreReviewCounter = fontBold(60)
